...
Bastion IDS is an open-source project. If you encounter bugs, want to suggest network security features, or wish to contribute to the signature rule sets and machine learning pipeline, please feel free to open an issue or submit a pull request.

## License

This project is licensed under the MIT License - see the LICENSE file for details. Free for academic, research, and open-source network security monitoring implementations.

---

*Built by [Kum Donalsien](https://github.com/kadian-arch) · 2026*
